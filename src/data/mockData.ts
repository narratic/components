...
export const deals: Deal[] = [
  {
    ...
    riskFactors: [
      ...
      },
      {
        ...
        category: "process",
        details:
          "No clear understanding of the customer's decision-making process.",
    ...
    riskFactors: [
      {
        ...
        category: "financial",
        details:
          "Customer indicated budget limitations for the current fiscal year.",
    ...
    riskFactors: [
      {
        ...
        impact:
          "Deal is likely to stall without further engagement from the sales team.",
      ...
      },
      {
        ...
        category: "competitive",
        details:
          "Customer evaluating 3 competitors including incumbent provider.",
