  ...
  sections: {
    B: {
      ...
      questions: [
        {
          question:
            "Has the prospect confirmed they have budget allocated for this solution?",
          weighting: 5,
          label: "Confirmed Budget Allocation",
        },
        {
          question: "Do you understand their budget approval process?",
          weighting: 4,
          label: "Approval Process",
        },
        {
          question:
            "Have you validated the budget amount matches your solution's price range?",
          weighting: 5,
          label: "Budget Fit",
        },
        {
          question:
            "Is there a defined budget cycle or fiscal year considerations?",
          weighting: 3,
          label: "Budget Cycle",
        },
      ],
    ...
    A: {
      ...
      questions: [
        ...
        {
          question: "Do you understand their decision-making process?",
          weighting: 4,
          label: "Decision Process",
        },
        {
          question:
            "Have you mapped all stakeholders involved in the decision?",
          weighting: 4,
          label: "Stakeholder Mapping",
        },
        {
          question: "Does your contact have purchasing authority?",
          weighting: 5,
    ...
    N: {
      ...
      questions: [
        {
          question: "Have you clearly identified their pain points?",
          weighting: 5,
          label: "Pain Points",
        },
        {
          question: "Is there a compelling event driving the need?",
          weighting: 4,
          label: "Compelling Event",
        },
        {
          question: "Have you quantified the cost of their current situation?",
          weighting: 4,
          label: "Cost of Current Situation",
        },
        {
          question: "Does your solution address their critical needs?",
          weighting: 5,
          label: "Solution Fit",
        },
      ],
    ...
    T: {
      ...
      questions: [
        ...
        {
          question: "Have key milestone dates been established?",
          weighting: 3,
          label: "Milestone Dates",
        },
        {
          question: "Are there any external factors affecting the timeline?",
          weighting: 3,
...
export const MEDDPICC_DATA: Framework = {
  ...
  enabled: true,
  description:
    "Metrics, Economic Buyer, Decision Criteria, Decision Process, Paper Process, Implications, Champion, Competition - A comprehensive enterprise sales qualification framework.",
  sections: {
    M: {
      name: "Metrics",
      deal_breaker:
      ...
      questions: [
        ...
        {
          question:
            "Do you know the current performance levels of these metrics?",
          weighting: 4,
          label: "Current Performance",
        },
        {
          question:
            "Are you aware of any benchmark or target metrics the prospect aims to achieve?",
          weighting: 4,
          label: "Benchmark Metrics",
        },
        {
          question:
            "Have you confirmed how the prospect measures and tracks these metrics?",
          weighting: 3,
        ...
        {
          question:
            "Have you mapped your solution's benefits directly to the prospect's key metrics?",
          weighting: 5,
          label: "Solution-Metrics Mapping",
        },
        {
          question:
            "Can you demonstrate how your solution will specifically improve these metrics?",
          weighting: 5,
          label: "Solution Impact",
        },
        {
          question:
            "Have you discussed and agreed upon how success will be measured post-implementation?",
          weighting: 4,
    ...
    E: {
      ...
      questions: [
        ...
        {
          question:
            "Do you understand the economic buyer's key priorities, motivations, and pain points?",
          weighting: 4,
          label: "Buyer Priorities",
        },
        {
          question:
            "Are you aware of how the economic buyer evaluates ROI and measures success?",
          weighting: 4,
          label: "ROI Evaluation",
        },
        {
          question:
            "Have you addressed any specific concerns or objections raised by the economic buyer?",
          weighting: 3,
          label: "Concerns Addressed",
        },
        {
          question:
            "Do you know the economic buyer's budget and any financial constraints?",
          weighting: 4,
        ...
        {
          question:
            "Have you established a strong relationship or rapport with the economic buyer?",
          weighting: 3,
        ...
        {
          question:
            "Do you understand the economic buyer's decision-making process and timeline?",
          weighting: 4,
    ...
    D: {
      ...
      questions: [
        {
          question:
            "Have you identified all the key decision criteria the prospect will use?",
          weighting: 5,
        ...
        {
          question:
            "Are the decision criteria formally documented, and have you obtained a copy?",
          weighting: 2,
    ...
    D2: {
      ...
      deal_breaker:
        "An undefined or overly complex decision process can stall the deal indefinitely.",
      questions: [
        {
          question:
            "Have you thoroughly mapped out the prospect's entire decision-making process?",
          weighting: 5,
          label: "Process Mapping",
        },
        {
          question:
            "Do you know all the steps and stages involved from evaluation to final decision?",
          weighting: 4,
        ...
        {
          question:
            "Do you understand the influence and concerns of each stakeholder?",
          weighting: 4,
        ...
        {
          question:
            "Have you identified potential obstacles or bottlenecks that could delay the decision?",
          weighting: 3,
          label: "Potential Obstacles",
        },
        {
          question:
            "Do you know what approvals are required and who grants them at each stage?",
          weighting: 4,
    ...
    P: {
      ...
      questions: [
        {
          question:
            "Do you understand the prospect's procurement and contracting processes in detail?",
          weighting: 5,
        ...
        {
          question:
            "Do you know the expected timelines for each step in the paper process?",
          weighting: 4,
          label: "Timeline for Paper Process",
        },
        {
          question:
            "Have you prepared and submitted all necessary contractual documents and agreements?",
          weighting: 5,
    ...
    I: {
      ...
      questions: [
        ...
        {
          question:
            "Have you explored and understood the root causes of these pain points?",
          weighting: 4,
        ...
        {
          question:
            "Do you know the urgency with which the prospect needs to address these pain points?",
          weighting: 4,
    ...
    C: {
      ...
      questions: [
        {
          question:
            "Have you identified and confirmed a champion within the prospect's organization?",
          weighting: 5,
        ...
        {
          question:
            "Is the champion actively advocating for your solution within their organization?",
          weighting: 5,
          label: "Champion Advocacy",
        },
        {
          question:
            "Does the champion fully understand and believe in the value your solution provides?",
          weighting: 4,
        ...
        {
          question:
            "Is the champion committed to helping you overcome internal objections or hurdles?",
          weighting: 4,
          label: "Champion Commitment",
        },
        {
          question:
            "Do you maintain regular and open communication with the champion?",
          weighting: 3,
    ...
    C2: {
      ...
      questions: [
        {
          question:
            "Are you aware of all the competitors the prospect is considering?",
          weighting: 5,
...
export const CHALLENGER_SALE_DATA: Framework = {
  ...
  enabled: true,
  description:
    "A framework focused on teaching, tailoring, and taking control of the sales conversation.",
  sections: {
    TC: {
      ...
      questions: [
        ...
        {
          question:
            "Can you articulate industry trends they may not be aware of?",
          weighting: 4,
    ...
    TP: {
      ...
      questions: [
        ...
        {
          question:
            "Is your value proposition resonating with their specific situation?",
          weighting: 5,
          label: "Value Proposition Relevance",
        },
        {
          question:
            "Have you connected your solution to their business outcomes?",
          weighting: 4,
    ...
    TC2: {
      ...
      questions: [
        {
          question:
            "Are you effectively managing and directing the sales conversation?",
          weighting: 4,
...
export const SOLUTION_SELLING_DATA: Framework = {
  ...
  enabled: true,
  description:
    "A problem-led selling approach focusing on the buyer's pain points and desired outcomes.",
  sections: {
    PP: {
      name: "Pain Points",
      questions: [
...
export const VALUE_BASED_SELLING_DATA: Framework = {
  ...
  enabled: true,
  description:
    "A framework focused on communicating and delivering value aligned with customer needs.",
  sections: {
    VD: {
